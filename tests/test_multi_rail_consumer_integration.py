...
class TestMultiRailConsumerIntegration:
    ...
    def consumer_multi_rail_fixture(self):
        ...
        fixture_path = Path(__file__).parent / "fixtures" / "multi_rail" / "consumer_multi_rail_example.json"
    ...
    def test_consumer_evaluation_crypto_stablecoin(self, consumer_evaluator, consumer_multi_rail_fixture):
        ...
        evaluation = consumer_evaluator.evaluate_consumer_combination(
            "Crypto", "stablecoin", merchant_proposal, 
            fixture["transaction_amount"], consumer_context
        )
    ...
    def test_consumer_evaluation_fednow_debit(self, consumer_evaluator, consumer_multi_rail_fixture):
        ...
        evaluation = consumer_evaluator.evaluate_consumer_combination(
            "FedNow", "debit_card", merchant_proposal,
            fixture["transaction_amount"], consumer_context
        )
    ...
    def test_consumer_negotiation_optimal_selection(self, consumer_negotiator, consumer_multi_rail_fixture):
        ...
        assert optimal.instrument_type in ["stablecoin", "debit_card", "credit_card"]  # Should be preferred instrument
    ...
    def test_consumer_negotiation_alternatives(self, consumer_negotiator, consumer_multi_rail_fixture):
    ...
    def test_consumer_rewards_calculation(self, consumer_negotiator, consumer_multi_rail_fixture):
        ...
        assert any(rt in ["cashback", "crypto_rewards", "points", "convenience", "cost_savings"] for rt in reward_types)
    ...
    def test_consumer_preference_prioritization(self, consumer_negotiator):
        ...
        consumer_context = {
            ...
            "available_rails": {
                "Crypto": {"supported_instruments": ["stablecoin"], "consumer_benefit": 0.03, "preferred": True},
                "Card": {"supported_instruments": ["credit_card"], "consumer_benefit": 0.02, "preferred": False}
            }
        }
    ...
    def test_consumer_negotiation_deterministic(self, consumer_negotiator, consumer_multi_rail_fixture):
        ...
        assert response1.consumer_proposal.instrument_type == response2.consumer_proposal.instrument_type
        assert abs(response1.consumer_proposal.consumer_benefit - response2.consumer_proposal.consumer_benefit) < 0.01
        assert abs(response1.consumer_proposal.convenience_score - response2.consumer_proposal.convenience_score) < 0.01
    ...
    def test_consumer_multi_rail_coverage(self, consumer_evaluator):
        ...
        consumer_context = {
            ...
            "available_rails": {
                "Crypto": {"supported_instruments": ["stablecoin"], "consumer_benefit": 0.03, "preferred": True},
                "FedNow": {"supported_instruments": ["debit_card"], "consumer_benefit": 0.01, "preferred": True},
                "Card": {"supported_instruments": ["credit_card", "debit_card"], "consumer_benefit": 0.02, "preferred": False}
            }
        }
        ...
        for rail_type, instrument_type in important_combinations:
            if (rail_type, instrument_type) in available_combinations:
                assert (rail_type, instrument_type) in evaluated_combinations, \
